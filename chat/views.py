...
class MessageView(View):
    def get(self, request, userid):
        ...
        chat = ChatModel.objects.filter(Q(user=self.request.user, other_chat_user__id=userid) | Q(
            user__id=userid, other_chat_user=self.request.user)).order_by('created_at')
